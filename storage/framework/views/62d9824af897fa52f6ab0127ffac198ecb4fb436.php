<?php $__env->startSection('boost-content'); ?>
    <div class="boost-rank">
        <?php echo e(Form::open(array('route' => 'Checkout_rating'))); ?>
            ...
            <div style="clear:both;">
                <span><?php echo app('translator')->getFromJson('boost.bnet_email'); ?></span><br /><hr /><br />
                <input type="email" name="bnet_email" class="bnet_email" placeholder="<?php echo app('translator')->getFromJson('boost.bnet_email'); ?>"/><br /><br /><hr /><br />
            </div>

            <div>
                <span><?php echo app('translator')->getFromJson('boost.bnet_pass'); ?></span><br /><hr /><br />
                <input type="password" name="bnet_pass" class="bnet_pass" placeholder="<?php echo app('translator')->getFromJson('boost.bnet_pass'); ?>"/><br /><br /><hr /><br />
            </div>
