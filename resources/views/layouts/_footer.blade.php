<div class="footer" style="clear:both;">
    <div>
        <ul>
            ...
            <li>
                <ul>
                    <a href="support"><li>@lang('header.support')</li></a>
                    <a href="login"><li>@lang('header.login')</li></a>
                    <a href="register"><li>@lang('header.register')</i></li></a>
                    <a href="jobs"><li>@lang('header.jobs')</i></li></a>
                </ul>
                <a href="http://bwatch.pro"><img class="footer-logo" src="{{asset('image/logo/boostwatch_text.png')}}" /></a><br />
